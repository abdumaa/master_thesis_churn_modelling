...
the minority class. Instead of simply duplicating some rows SMOTE creates new nearest neighbors in terms of feature characteristics for the minority class examples. \\
While constructing the feature characteristics of the new examples as a new nearest neighbor for example $i$ of the minority class one has to differentiate between continuous and nominal features. For the nominal features the one takes


\subsubsection*{(iv) Cost-Sensitive Classifiers}
