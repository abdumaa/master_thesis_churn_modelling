...
One drawback of the presented sampling methods is that the sample distributions are being changed. A different starting point is to to change the objective cost function which
...
The fact that these costs can come from multiple sources which are not easily definable is one part of the reasoning. \\
