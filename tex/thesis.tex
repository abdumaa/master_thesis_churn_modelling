...
For this work we use customer data of a big insurance company. Due to data pretection the data is anonymized which does not
affect the model accuracy and interpretability in any form. We focus on one product for this company, where customers close
a deal to get the desired service. 
