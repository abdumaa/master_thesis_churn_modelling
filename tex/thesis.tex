...
Furthermore, we want to declare one possible extension of this work which contains a different modelling approach. The idea is to model the events giving the customer the right of mid-contract termination separately. In the tree diagram of figure \ref{fig:tree_diag} we show how the event sequence leading to a churn is constructed. \\
